...
class WebRtcManager(private val context: Context) {
    ...
    fun initPeerConnection(
        ...
        Log.d(TAG, "initPeerConnection 진입 - localAudioTrack=${localAudioTrack != null}, localVideoTrack=${localVideoTrack != null}, remoteRenderer=${remoteRenderer != null}")
        this.currentCallId = callId
        this.isCaller = isCaller
        this.firebaseDb = db

        val turnUsername = "297ed53aa88c6b8ccd19cb7a"
        val turnPassword = "Cav9te/6odu1y1He"
